                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="features-grids">
                            ...
                            <div class="grid">
                                <div class="icon">
                                    <img class="work-img" src="{{asset('public/user/img/works/'.$work->image)}}">
                                </div>
                                <h3>{{$work->title}}</h3>
                                <p>{!! clean($work->description) !!}</p>
                            </div>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="list-group">
                      ...
                      <a href="{{ route('user.blog.categorywise', $category->id) }}" class="list-group-item list-group-item-action">{{$category->name}}</a>
                      @endforeach
                    </div>
                            ...
                            <div class="widget search-widget">
                                ...
                                <form action="{{route('advance.search')}}" method="GET">
                                    ...
                                    <div class="search_box">
                                        <input type="text" class="form-control" name="title" placeholder="Enter Search Keyword">
