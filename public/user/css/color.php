...
.contact-pg-section-s2 form textarea:focus, .list-group-item.active, .list-group-item.active:focus, .list-group-item.active:hover{
...
.about-section .video-holder::before, .about-section-s2 .video-holder::before{
    border: 12px solid <?php echo  $color ?>;
}

.gallery-item .overlay-box
{
    background: <?php echo hex2rgba($color, 0.8); ?>;
}
